...
<script type="text/javascript">
	function genPdf() {
		...
		if (isValid == true) {
			...
			window
					.open('${pageContext.request.contextPath}/pdf?reportURL=pdf/showSellDateItemwisewiseReportpPdf/'
							+ fromDate
							+ '/'
							+ toDate
							+ '/'
