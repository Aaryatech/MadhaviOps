			...
			<div class="sidebarright">
				...
				<div class="colOuter">
					<div align="center">
						<div class="col1">
							<div class="col1title">
								<b> <span class="frm_txt">From</span>
								</b> <input id="fromdatepicker" placeholder="From Date"
									name="from_Date" class="texboxitemcode texboxcal float_l"
									type="text" size="35" autocomplete="off">
							</div>
						</div>
						<div class="col2">
							<div class="col1title">
								<b> <span class="frm_txt">To</span>
								</b> <input id="todatepicker" placeholder="To Date" name="to_Date"
									type="text" class="texboxitemcode texboxcal float_l" size="35"
									autocomplete="off">
							</div>
						</div>
						<input type="hidden" name="frId" id="frId" value="${frId}" /> <input
				...
				<div id="chart" style="display: none">
					...
					<div>
						...
						<div id="chart_div" style="width: 60%; height: 600; float: left;"
					...
					<div class="colOuter">
						...
						<div id="PieChart_div" style="width: 100%; height: 300;"
							align="center"></div>
					</div>
			...
			$
					.getJSON(
							...
							function(data) {
												...
												function(key, sellBillData) {
													...
													tr
															.append($(
																	...
																	.html(
																			'<p style="color:blue;"  onclick=itemSellBill('
																					+ sellBillData.catId
																					+ ');>'
								...
								$('#table_menu tbody').append(trclosed);
							...
							function(data) {
								...
								function drawStuff() {
									...
									function drawQtyChart() {
										...
										var options = {
											'title' : 'Sell Qauntity per Category',
											'width' : 400,
											'height' : 250
										};
									...
									function drawAmtChart() {
										...
										var options = {
											'title' : 'Sell Amount per Category',
											'width' : 400,
											'height' : 250
										};
...
<script type="text/javascript">
	function genPdf() {
		...
		if (isValid == true) {
			...
			window
					.open('${pageContext.request.contextPath}/pdf?reportURL=pdf/showSellCategoryWiseReportpPdf/'
