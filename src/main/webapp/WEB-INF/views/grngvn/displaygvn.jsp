				...
				<div class="colOuter">
					...
					<div class="col-md-6">
						<form action="" id="gvnForm" method="get">
							...
							<table border="1">
								<tr bgcolor="orange">
									<th width="30%"  style="text-align: center;">Gvn Date</th>
									<th width="40%"  style="text-align: center;">Gvn SrNo</th>
									<th width="30%"  style="text-align: center;">Approved Amt</th>
								</tr>
								<tbody>
									<tr>
										<td  style="text-align: center;">${gvnDate}</td>
										<td  style="text-align: center;">${gvnSrNo}</td>
										<td  style="text-align: center;">${aprAmt}</td>
									</tr>
								</tbody>
							</table>
								...
								<table id="table_grid" class="main-table" style="width: 100%">
									...
									<tbody>
										...
										<c:forEach items="${gvnList}" var="gvnList" varStatus="count">
											...
											<c:choose>
												<c:when
													test="${gvnList.grnGvnQty!=gvnList.aprQtyAcc or gvnList.grnGvnStatus==7}">
											...
											<tr class="${color}">
												...
												<td class="col-md-1" style="text-align: right;"><c:out value="${gvnList.itemRate}" /></td>
												<td class="col-md-1" style="text-align: right;"><c:out value="${gvnList.itemRate}" /></td>

												<td class="col-md-1" style="text-align: right;"><c:out
														value="${gvnList.grnGvnQty}" /></td>


												<td class="col-md-2" style="text-align: right;"><c:out
														value="${gvnList.grnGvnAmt}" /></td>
												<td class="col-md-1" style="text-align: right;"><c:out
														value="${gvnList.aprQtyAcc}" /></td>
												<td class="col-md-1" style="text-align: right;"><c:out
