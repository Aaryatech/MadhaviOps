...
<table width="250" border="0" cellspacing="0" cellpadding="0" style="padding:0px; font-family:Times New Roman; font-size:12px; border:1px solid #E7E7E7;">
 ...
 <tr>
    ...
    <tr>
      <td colspan="2" align="center" style="padding:3px; border-bottom:1px solid #E7E7E7;"><span style="font-size: 12px; font-family: Times New Roman;"><b>${sessionScope.frDetails.frName}</b></span><br /><span style="font-size: 10px; font-family: Times New Roman;">(Madhvi)</span>
       </td>
    </tr>
    <tr>
