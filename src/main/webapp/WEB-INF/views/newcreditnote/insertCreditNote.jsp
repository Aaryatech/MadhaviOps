									...
									<table id="table_grid" class="main-table">
										<thead>
											<tr class="bgpink">
												...
												<th class="col-md-1" style="text-align: right;">Bill
													Qty</th>
												<th class="col-md-1" style="text-align: right;">Disc</th>
												<th class="col-md-1" style="text-align: center;">Qty</th>

												<th class="col-md-1" style="text-align: right;">Bill
													Total</th>
												<th class="col-md-1" style="text-align: right;">Ret %</th>
												<th class="col-md-1" style="text-align: right;">Taxable
													Amt</th>
												<th class="col-md-1" style="text-align: right;">Tax Amt</th>
												<th class="col-md-1" style="text-align: right;">Cess</th>
												<th class="col-md-1" style="text-align: right;">Grand
													Total</th>
